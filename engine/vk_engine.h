...
constexpr unsigned int SHADOW_MAP_CASCADE_COUNT = 3;
...
public:
	...
	void prepare_culling();

	void prepare_light_culling();

	void prepare_shadowmap();


	void render_scene(uint32_t swapchainImageIndex);
